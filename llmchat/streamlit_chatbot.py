...
nlp = pipeline("text-generation", model=model_path,device=torch.device('cuda'))
...
sender_name = st.selectbox(
    'Who are you',
    ('Dubey','Vijay Pune', 'RAVISH RANA', 'Faraz', 'Karan Gupta', 'Saurabh Dasgupta', 'Shashank Purohit', 'Shashank Purohit' ))
